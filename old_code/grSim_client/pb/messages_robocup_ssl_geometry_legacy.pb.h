...
class SSL_GeometryFieldSize :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:RoboCup2014Legacy.Geometry.SSL_GeometryFieldSize) */ {
 public:
...
class SSL_GeometryData :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:RoboCup2014Legacy.Geometry.SSL_GeometryData) */ {
 public:
  SSL_GeometryData();
