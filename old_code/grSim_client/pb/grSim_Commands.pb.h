...
class grSim_Robot_Command :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:grSim_Robot_Command) */ {
 public:
  grSim_Robot_Command();
...
class grSim_Commands :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:grSim_Commands) */ {
 public:
  grSim_Commands();
