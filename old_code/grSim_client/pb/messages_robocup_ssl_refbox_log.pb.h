...
class Log_Frame :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:Log_Frame) */ {
 public:
  Log_Frame();
  virtual ~Log_Frame();
...
class Refbox_Log :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:Refbox_Log) */ {
 public:
  Refbox_Log();
  virtual ~Refbox_Log();
