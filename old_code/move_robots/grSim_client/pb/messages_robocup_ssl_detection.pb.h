...
class SSL_DetectionBall :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:SSL_DetectionBall) */ {
 public:
  SSL_DetectionBall();
...
class SSL_DetectionRobot :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:SSL_DetectionRobot) */ {
 public:
  SSL_DetectionRobot();
